      ...
      <div style={{minHeight:'100vh',background:'#0D0608',color:'#F8DE22',position:'relative',zIndex:1}}>
        ...
        <nav style={{borderBottom:'1px solid rgba(248,222,34,0.07)',padding:'14px 32px',display:'flex',alignItems:'center',justifyContent:'space-between',backdropFilter:'blur(20px)',background:'rgba(13,6,8,0.85)',position:'sticky',top:0,zIndex:50}}>
          ...
          <div style={{display:'flex',alignItems:'center',gap:'16px'}}>
            <Link href="/campaigns" style={{fontFamily:'IBM Plex Mono',fontSize:'11px',letterSpacing:'2px',color:'rgba(248,222,34,0.4)',textDecoration:'none',textTransform:'uppercase'}}>Campaigns</Link>
            <Link href="/tutorial" style={{fontFamily:'IBM Plex Mono',fontSize:'11px',letterSpacing:'2px',color:'#F8DE22',textDecoration:'none',textTransform:'uppercase'}}>Tutorial</Link>
